...
@interface OLEGOLatestHeaderView()
@property (nonatomic,strong) UIImageView * arrowImageView;
@property (nonatomic,strong) UIImageView * loadingImg;
@end
@implementation OLEGOLatestHeaderView
...
-(void)initPreViews
{
    ...
    images.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
    ...
    CGFloat bottomExtend = 30;//距离顶部高度
    CGPoint pt = CGPointMake(rect.size.width/2.0, bottomExtend + imageHeight/2.0);
    images.center = pt;
